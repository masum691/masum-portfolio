                    ...
                    <div>
                        <form ref={form} onSubmit={sendEmail} class="row g-3 ps-lg-5 contact-form">
                            <div class="col-md-6">
                                ...
                                <input type="text" name="name" class="form-control shadow border-0 p-3 name-input" id="inputEmail4" placeholder="Your name" required />
                            </div>
                            <div class="col-md-6">
                                <label htmlFor="email" class="form-label">Email *</label>
                                <input type="email" name="email" class="form-control shadow border-0 p-3" placeholder="Your email" required />
                            </div>
                            <div class="col-12">
                                <label htmlFor="subject" class="form-label">Subject</label>
                                <input type="text" name="subject" class="form-control shadow border-0 p-3" placeholder="Subject" />
                            </div>
                            <div class="col-12">
                                <label htmlFor="subject" class="form-label">Message *</label>
                                <textarea className="rounded w-100 border-0 shadow p-3" name="message" rows="6" placeholder="Your message" required></textarea>
                            </div>
                            <div class="col-12">
